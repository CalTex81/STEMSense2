...
export const StemSenseLogo = () => (
  <svg className="logo-svg" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ width: "48px", height: "48px", color: "var(--teal)" }}>
...
export const BeakerSvg = () => (
  <svg viewBox="0 0 80 100" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M15 15 L15 85 C15 90 20 92 25 92 L65 92 C70 92 75 90 75 85 L75 15 L70 15 L70 10" 
      stroke="#2c8b8b" strokeWidth="3" fill="rgba(44,139,139,0.12)" strokeLinejoin="round" />
    <line x1="15" y1="15" x2="75" y2="15" stroke="#2c8b8b" strokeWidth="3" />
    <path d="M15 30 L30 30 M15 50 L40 50 M15 70 L30 70" stroke="#2c8b8b" strokeWidth="2" />
    <ellipse cx="45" cy="88" rx="20" ry="3" fill="rgba(44,139,139,0.2)" />
  </svg>
);
